...
export default function Header() {
  return (
    <header className="h-20 border-b border-border-warm bg-bg-warm sticky top-0 z-50">
      <div className="w-full max-w-[940px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <button className="hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-surface border border-border-warm text-ink hover:border-terracotta hover:text-terracotta transition-colors">
            <User className="w-5 h-5" />
          </button>
          <button className="bg-terracotta text-white px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wide hover:bg-opacity-90 transition-opacity flex items-center gap-2">
