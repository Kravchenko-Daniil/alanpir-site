    ...
    <article className="py-10 md:py-14 max-w-3xl mx-auto">
      ...
      <section className="space-y-6 text-ink leading-relaxed">
        ...
        <div>
          ...
          <p>Пекарня работает: будни 8:30–20:00, выходные 10:00–17:00. Заказы через сайт принимаются круглосуточно, доставка — в рабочие часы.</p>
          <p className="mt-3">Условия доставки зависят от зоны:</p>
          <ul className="list-disc pl-6 space-y-1 mt-1">
            <li>Соседние станции (Достоевская, Марьина роща) — бесплатно, без минимального заказа</li>
            <li>В пределах Садового кольца — минимальный заказ 1 000 рублей, доставка 150 рублей</li>
            <li>В пределах Третьего транспортного кольца (ТТК) — минимальный заказ 1 500 рублей, доставка 250 рублей</li>
            <li>В пределах МКАД — минимальный заказ 2 000 рублей, доставка 250 рублей</li>
            <li>За МКАД — минимальный заказ 5 000 рублей, стоимость доставки уточняется у оператора</li>
          </ul>
          <p className="mt-3">Самовывоз — по адресу {SITE_ADDRESS.city}, {SITE_ADDRESS.street}.</p>
        </div>
